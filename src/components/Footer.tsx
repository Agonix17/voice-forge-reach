    ...
    <footer className="border-t border-border py-12 mt-16">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">
              Premium AI video localization built for Minecraft creators. Made by gamers, for gamers.
            </p>
          </div>
          <div>
            <div className="text-xs font-mono uppercase tracking-widest text-muted-foreground mb-4">Product</div>
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#why" className="text-foreground/70 hover:text-primary transition-colors">Process</a></li>
            </ul>
          </div>
          <div>
            <div className="text-xs font-mono uppercase tracking-widest text-muted-foreground mb-4">Connect</div>
            <ul className="space-y-2 text-sm">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <div>© 2026 VoxLocalize. Built for creators, by creators.</div>
