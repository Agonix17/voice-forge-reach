        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="rounded-xl border border-border bg-surface p-8 md:p-10">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                {selectedPackage ? (
                  ...
                  <div className="rounded-xl border border-border bg-surface p-4 text-muted-foreground text-sm flex items-center justify-between gap-3">
                    <span>{t("form.noPackage")}</span>
                    <a href="#pricing" className="text-xs text-primary underline whitespace-nowrap">{t("form.changePlan")}</a>
                  </div>
                )}
              </div>
              ...
              {error && (
                <p className="text-sm text-center text-destructive">{t("form.error")}</p>
              )}
